package metrics.jbleu;

import com.google.common.base.*;
import com.google.common.collect.*;
import metrics.jbleu.util.Ngram;
...
public class JBLEU {
  ...
  public static void main(String[] args) {
    ...
    List<String> hyp = Lists.newArrayList(Splitter.on(' ').split("ataque coração."));
    List<List<String>> refs = new ArrayList<List<String>>();
    refs.add(Lists.newArrayList(Splitter.on(' ').split("ataque cardíaco.")));
    refs.add(Lists.newArrayList(Splitter.on(' ').split("ataque de coração.")));
